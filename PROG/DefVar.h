...
#define Vb82BilanciereSu_RigheCN	vb82		// =1 nel ciclo Righe, se premo la pedana si alza il bilanciere
...
//#define Vb96_EnableJogXYPlc			vb96		// = 1 in fase di hold è possibile fare i jog con i tasti +- del HMI
...
#define Vb122_MZRulliScarAttivo		vb122		//1 = HMI ha attivato la funzione rulli scaricatore tramite motore
...
#define EnbCountIRQPiegatore_Su_IDX			4089 				///// [INT] HMI utilizzato per abilitare il conteggio del sensore piegatore su
#define Vb4089_IRQPiegatore_Su				Vb4089 						///// abilitare  IRQ per leggere il sensore piegatore su
...
#define Vb4154_AppMan_o22_Scaric_dx_sx					Vb4154
#define	Vb4155_AppMan_o23								Vb4155
...
#define Vb4171_AppMan_o22_PinzaDietroCaricMZ			Vb4171
#define Vb4172_AppMan_o23_MZ_RulliSca_SuGIu				Vb4172
#define Vb4173_AppMan_o30_MZ_SoffiLamiera				Vb4173
...
#define Vb4354_AppAut_o22_Scaric_dx_sx					Vb4354
...
#define Vb4371_AppAut_o22_PinzaDietroCaricMZ			Vb4371
#define Vb4372_AppAut_o23_MZ_RulliSca_SuGIu				Vb4372
#define Vb4373_AppAut_o30_MZ_SoffiLamiera				Vb4373
...
#define VbChn1Emerg				vb7909		// VB canale 1 in emergenza
...
#define	Vn5CodiceAllarmeCambioSpola		vn5			// = 1 nessuno posto vuoto
...
#define Vn221StatusIdx1Revolver			vn221		//0 = Idle, 1 = spola non presente, 2 = spola presente, 3 = spela già caricata
#define Vn222StatusIdx2Revolver			vn222		//0 = Idle, 1 = spola non presente, 2 = spola presente, 3 = spela già caricata
#define Vn223StatusIdx3Revolver			vn223		//0 = Idle, 1 = spola non presente, 2 = spola presente, 3 = spela già caricata
#define Vn224StatusIdx4Revolver			vn224		//0 = Idle, 1 = spola non presente, 2 = spola presente, 3 = spela già caricata
#define Vn225StatusIdx5Revolver			vn225		//0 = Idle, 1 = spola non presente, 2 = spola presente, 3 = spela già caricata
#define Vn226StatusIdx6Revolver			vn226		//0 = Idle, 1 = spola non presente, 2 = spola presente, 3 = spela già caricata
#define Vn227StatusIdx7Revolver			vn227		//0 = Idle, 1 = spola non presente, 2 = spola presente, 3 = spela già caricata
#define Vn228StatusIdx8Revolver			vn228		//0 = Idle, 1 = spola non presente, 2 = spola presente, 3 = spela già caricata
...
//#define VN_SYS_PAGE_ID			vn3804		// ex Vn3804_PageID Pagina in esecuzione
...
#define DeltaFirst_C1_AsseX     vq70        // Cucitrice 1 - PosX - QuotaPrimo Punto
#define DeltaFirst_C1_AsseY     vq71        // Cucitrice 1 - PosY - QuotaPrimo Punto
...
#define Vq_110_READ_FC_ind_CARIC        vq110      // Vq lettura fine corsa indietro asse Y
#define Vq_111_READ_FC_ava_CARIC        vq111      // Vq lettura fine corsa avanti asse Y





#define vq121FUN107_MasterErr		vq121		//= Errore istantaneo Master [mm]
#define vq122FUN107_SlaveErr		vq122		//= Errore istantaneo Slave [mm]
#define vq123FUN107_DifMasterSlave	vq123		// = Differenza tra le posizione master e slave [mm] ( valore assoluto )
#define vq124FUN107_DifMaxMastSlave	vq124		// = Valore massimo della differenza tra le posizione master e slave [mm] ( valore assoluto )
#define vq125FUN107_SogliaAllGantry	vq125		// = Soglia di allarme inseguimento gantry [mm] impostata nei parametri assi
#define vq126FUN107_MasterFolErr	vq126		// = Emergenza GANTRY FOLLOW ERROR: errore istantaneo Master [mm]
#define vq127FUN107_SlaveFolErr		vq127		//= Emergenza GANTRY FOLLOW ERROR: errore istantaneo Slave [mm]
#define vq128FUN107_DiffFolErr		vq128		// = Emergenza GANTRY FOLLOW ERROR:  valore assoluto della differenza tra le posizione master e slave [mm]
//------------------------------------------------------------------------
//
// #######################################
...
#define Copia_DeltaFirst_C1_AsseX_34	vq4900
#define Copia_DeltaFirst_C1_AsseY_34	vq4901
#define Copia_DeltaFirst_C1_AsseX_35	vq4902
#define Copia_DeltaFirst_C1_AsseY_35	vq4903
#define Copia_DeltaFirst_C1_AsseX_36	vq4904
#define Copia_DeltaFirst_C1_AsseY_36	vq4905
#define Copia_DeltaFirst_C1_AsseX_37	vq4906
#define Copia_DeltaFirst_C1_AsseY_37	vq4907
#define Copia_DeltaFirst_C1_AsseX_38	vq4908
#define Copia_DeltaFirst_C1_AsseY_38	vq4909
...
#define i8_FcPiegatore_DI		din8	//i8_C1_FcMaxAsseY
#define i9_FcPiegatoreBasso 	din9	// 
#define i10_Piegatore_Salito	din10
#define i11_FcLancia_DI 		din11	//
#define i12_Pressostato			din12	//
#define i13						din13	//
#define i14_MZRullo1Su			din14	//
#define i15_MZRullo2Su			din15	//
#define i16_MZRullo3Su			din16	//

#define i17						din17	//
#define i18_RotturaFilo 		din18	//
...
#define i33_AutoBC_Braccio_Off	din33		//AutoBobbinChanger
#define i34_AutoBC_Braccio_On	din34		//AutoBobbinChanger
#define i35_AutoBC_PresenzaSpol	din35		//AutoBobbinChanger
#define i36_AutoBC_Rot_on		din36		//AutoBobbinChanger
#define i37_AutoBC_Rot_off		din37		//AutoBobbinChanger
// ============================================================================
//      USCITE DIGITALI
// ============================================================================
...
#define o22_Scaric_dx_sx			dout22      //
#define o22_MZ_PinzaDietroCaric		dout22		//862MZ
#define o23_Lentezza_Tasca_AD		dout23      //
#define o23_MZ_RulliSca_SuGIu		dout23		//862MZ
...
#define o30_MZ_SoffiLamiera			dout30      //862MZ
...
#define o38_rullo_rinforzo			dout38		
